...
P6_XnoiseRobustness_3levels <- function(DatasetName,Criterion)
{
#############################################################################
...
#############################################################################
	...
	{	
		...
		{
			par(mfrow=c(1,1))
			plot(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.5),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2)
		}
		...
		{ 
			...
			for (outX in seq(outX_Min,outX_MAX,by=StepSize))
			{
				...
				if (outX > 0)
				{
					...
					outlying_X = runif(outlier_nbr,min = -2,max = 2)	#Importance de l'erreur d'outlier en Y
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey45')
		...
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.5),type='l',lty=1,lwd=2,cex.axis=2,col = 'grey55')
		...
		if (DatasetName == "santafe.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,0.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}		###FIN AMPLITUDE 2###
		#####################
		...
		{ 
			...
			for (outX in seq(outX_Min,outX_MAX,by=StepSize))
			{
				...
				if (outX > 0)
				{
					...
					outlying_X = runif(outlier_nbr,min = -3,max = 3)	#Importance de l'erreur d'outlier en Y
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey65')
		...
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.5),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
		...
		if (DatasetName == "santafe.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,0.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')		
		}
	...
	if (Criterion == "DT") 
	{
		...
		{
			par(mfrow=c(1,1))
			plot(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,0.9),type='l',lty=1,lwd=2,cex.axis=2)
		...
		{
			par(mfrow=c(1,1))
			plot(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2)
		}
		...
		{
			par(mfrow=c(1,1))
			plot(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(800,2100),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2)
		}
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey45')
		...
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
		...
		if (DatasetName == "santafe.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(1200,2100),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey65')
		...
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
		...
		if (DatasetName == "santafe.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(1200,2100),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')
		}
	...
	if (Criterion == "NLR2")
	{
		...
		{
			par(mfrow=c(1,1))
			plot(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.1),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2)		
		}
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.7),type='l',lty=1,lwd=2,cex.axis=2,col='grey45')
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.7),type='l',lty=1,lwd=2,cex.axis=2,col='grey65')
