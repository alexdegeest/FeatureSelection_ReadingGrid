...
P6_YnoiseRobustness_3levels <- function(DatasetName,Criterion)
{
#############################################################################
# Test a criterion on a dataset DatasetName for property 6 "Y Noise Robustness"
#
# Inputs:
#   - DatasetName
#	- Criterion
...
#############################################################################
	...
	outY_Min = 0
	StepSize = 0.05
	MatrixSize = (outY_MAX/StepSize)-(outY_Min/StepSize)+1
	...
	{	
		...
		{ 
			...
			for (outY in seq(outY_Min,outY_MAX,by=StepSize))
			{
				j = j + 1
				
				if (outY > 0)
				{
					outlier_prop = outY							    #Proportion d'outliers
					...
					outlying_Y = runif(outlier_nbr,min = -0.33,max = 0.33)	#Importance de l'erreur d'outlier en Y
					...
					for (i in seq(1,outlier_nbr,by=1)) #Ajouter du bruit aux points mais pas les remplacer par du bruit
					{
						dataset1_outliers[outlier_pos[i],2]= dataset1_outliers[outlier_pos[i],2] + outlying_Y[i]
						dataset2_outliers[outlier_pos[i],2]= dataset2_outliers[outlier_pos[i],2] + outlying_Y[i]		
						dataset3_outliers[outlier_pos[i],2]= dataset3_outliers[outlier_pos[i],2] + outlying_Y[i]
					}
		...
		{
			par(mfrow=c(1,1))
			plot(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.15),type='l',lty=1,lwd=2,cex.axis=2)
		...
		{
			par(mfrow=c(1,1))
			plot(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2)
		}
		...
		{
			par(mfrow=c(1,1))
			plot(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0.1,1.1),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2)
		}
		...
		{ 
			...
			for (outY in seq(outY_Min,outY_MAX,by=StepSize))
			{
				...
				if (outY > 0)
				{
					...
					outlying_Y = runif(outlier_nbr,min = -0.66,max = 0.66)	#Importance de l'erreur d'outlier en Y
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.15),type='l',lty=1,lwd=2,cex.axis=2,col='grey45')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey45')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey45')
		}
		
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}
		
		if (DatasetName == "santafe.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0.1,1.1),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}		
		...
		{ 
			...
			for (outY in seq(outY_Min,outY_MAX,by=StepSize))
			{
				...
				if (outY > 0)
				{
					...
					outlying_Y = runif(outlier_nbr,min = -1,max = 1)	#Importance de l'erreur d'outlier en Y
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.15),type='l',lty=1,lwd=2,cex.axis=2,col='grey65')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey65')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey65')
		}

		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0,1.6),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')
		}
		
		if (DatasetName == "santafe.mat")
		{
			lines(resultatMI1unif_Avg[,1],resultatMI1unif_Avg[,2], ylim=c(0.1,1.1),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatMI2unif_Avg[,1],resultatMI2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatMI3unif_Avg[,1],resultatMI3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')
		}
		###FIN AMPLITUDE 3###
	...
	{			
		...
		{
			par(mfrow=c(1,1))
			plot(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0.1,0.8),type='l',lty=1,lwd=2,cex.axis=2)
		...
		{
			par(mfrow=c(1,1))
			plot(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,1.2),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2)
		}
		...
		{
			par(mfrow=c(1,1))
			plot(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(800,3000),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2)
		}
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,0.8),type='l',lty=1,lwd=2,cex.axis=2,col='grey45')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey45')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey45')
		}
		
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,2),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}
		
		if (DatasetName == "santafe.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(800,3000),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,0.8),type='l',lty=1,lwd=2,cex.axis=2,col='grey65')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey65')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey65')
		}
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(0,2),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')
		}
		
		if (DatasetName == "santafe.mat")
		{
			lines(resultatDT1unif_Avg[,1],resultatDT1unif_Avg[,2], ylim=c(800,3000),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatDT2unif_Avg[,1],resultatDT2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatDT3unif_Avg[,1],resultatDT3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')
		}
	...
	if (Criterion == "NLR2")
	{
		...
		{
			par(mfrow=c(1,1))
			plot(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.5),type='l',lty=1,lwd=2,cex.axis=2)
		...
		{
			par(mfrow=c(1,1))
			plot(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.08),type='l',lty=1,lwd=2,cex.axis=2)
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2)
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2)		
		}		
		#AMP 1
			...
			for (outY in seq(outY_Min,outY_MAX,by=StepSize))
			{
				...
				for (K in seq(K_Initial, K_Final, by=Step_K)) #Boucle sur les K voisins
				{
					...
					for (k in seq(1,Nbr_Features,by=1))
					{
						...
						{
							results1 <- lm(NN1_Y[j,]~NN1_X[j,])
							#results1 <- lm(NN1_Y[j,]~NN1_X[j,]+NN1_Z[j,])
							R_Carre_adj[j,k] <- summary(results1)$adj.r.squared
						}
						Mean_R_Carre_adj[r,k]=mean(R_Carre_adj[,k])
					}
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.5),type='l',lty=1,lwd=2,cex.axis=2,col='grey45')
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey45')
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey45')
		}
		
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.7),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}
		
		if (DatasetName == "santafe.mat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.1),type='l',lty=1,lwd=2,cex.axis=2,col='grey55')
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey55')
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey55')
		}
		...
		if (DatasetName == "poland_30.mat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.5),type='l',lty=1,lwd=2,cex.axis=2,col='grey65')
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey65')
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey65')
		}
		
		if (DatasetName == "anthrokidsV2.dat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.7),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')
		}
		
		if (DatasetName == "santafe.mat")
		{
			lines(resultatR1unif_Avg[,1],resultatR1unif_Avg[,2], ylim=c(0,0.1),type='l',lty=1,lwd=2,cex.axis=2,col='grey80')
			lines(resultatR2unif_Avg[,1],resultatR2unif_Avg[,2],pch=10, lty=4,lwd=2,col='grey80')
			lines(resultatR3unif_Avg[,1],resultatR3unif_Avg[,2],pch=10, lty=3,lwd=2,col='grey80')	
		}
		#AMP 3
